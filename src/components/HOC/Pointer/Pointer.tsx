...
import { COLOR_PRIMARY, COLOR_RED, COLOR_TOOLTIP_BACKGROUND } from 'src/const';
import { Listing } from 'src/interfaces/idashboard';
...
const Pointer = ({
  ...
  if (data.room_type == 'entire_home') {
    icon = <FiberManualRecordSharpIcon style={{ fontSize: 14, color: COLOR_PRIMARY }} />;
  } else if (data && data.room_type && data.room_type.includes('private')) {
    icon = <FiberManualRecordSharpIcon style={{ fontSize: 14, color: '#F4B400' }} />;
  } else {
    icon = <FiberManualRecordSharpIcon style={{ fontSize: 14, color: '#DB4437' }} />;
  }
